...
/**
 * Responsive型 を CSSプロパティとその値に変換する (レスポンシブ対応・Theme対応の記述を簡潔にするユーティリティ関数)
...
export function toPropValue<T>(
  ...
  /**
    ...
    -- toPropValue('margin-bottom',1,theme) >> 'margin-bottom: 8px'
    ・この時、 const space: string[] = ['0px', '8px', '16px', '32px', '64px'];
    ・の二番目の要素である '8px' が適応されている。
