...
/**
   Boxコンポーネント
   レイアウト用のユーティリティコンポーネント
   スペーシング、縦横、カラーリング、ボーダー、ボジション等のレイアウトに関する設定を行う
   
   [Docs]
   -- ${(props) => toPropValue(...)} は与えられた props でマッチするものがあればCSSプロパティと値の文字列を返す
   -- マッチしない場合は空文字を返すため、展開時には無視される
 */
